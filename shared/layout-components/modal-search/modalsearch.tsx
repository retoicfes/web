...
const Modalsearch = () => {
  ...
  return (
    <div id="search-modal" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none"  onClick={handleClose}>
    <div className="ti-modal-box pointer-events-auto">
        ...
        <div className="ti-modal-body">
          ...
          <div className="my-[1.5rem]">
            ...
            <div id="dismiss-alert" role="alert"
              ...
              <Link href="/components/pages/notifications/"><span>Notifications</span></Link>
            ...
            <div id="dismiss-alert1" role="alert"
              className="!p-2 border dark:border-defaultborder/10 rounded-[0.3125rem] flex items-center text-defaulttextcolor dark:text-defaulttextcolor/70 !mb-2 !text-[0.8125rem] alert">
              <Link href="/components/ui-elements/alerts/"><span>Alerts</span></Link>
            ...
            <div id="dismiss-alert2" role="alert"
              ...
              <Link href="/components/pages/email/mail-app/"><span>Mail</span></Link>
