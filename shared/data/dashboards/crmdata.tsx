import { ApexOptions, type XAxisAnnotations } from "apexcharts";
import SafeApexChart from "@/shared/components/charts/SafeApexChart";
...
export class Revenueanalytics extends Component<{}, spark3> {
    ...
    render() {
        return (
            <div>
                <SafeApexChart options={this.state.options} series={this.state.series} type="line" height={350} />
            </div>
...
export class Target extends Component<{}, spark3> {
    ...
    render() {
        return (
            ...
            <div id="chart">
                <SafeApexChart options={this.state.options} series={this.state.series} type="radialBar" width={100} height={127} />
            </div>
        );
    }
}
...
export class Customers extends Component<{}, spark3> {
    ...
    render() {
        return (
            <div>
                <SafeApexChart options={this.state.options} series={this.state.series} type="line" height={40} width={100} />
            </div>
...
export class Earned extends Component<{}, spark3> {
    ...
    render() {
        return (
            <div>
                <SafeApexChart options={this.state.options} series={this.state.series} type="bar" height={180} />
            </div>
...
export class Sourcedata extends Component<{}, spark3> {
    ...
    render() {
        return (
            <SafeApexChart options={this.state.options} series={this.state.series} type="donut" height={242} />
        );
    }
}
